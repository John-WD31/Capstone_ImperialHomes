<x-layout>
      ...
      <x-card class="p-5">
        <div>
          <a href="/listings/property" class="inline-block text-white/50 hover:text-white/100 rounded-md bg-gray-600/50 hover:bg-gray-600 py-2 px-4 "
        ...
        <div class="mx-6 py-10 text-center md:text-left">
          <div class="grid grid-1 md:grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <h2 class="text-white">Set an Appointment</h2>
